...
if(isset($_POST['update_profile'])){
  ...
  $query = "update users set
   fname='$_POST[fname]',lname='$_POST[lname]',email='$_POST[email]',password='$_POST[password]',class='$_POST[class]' where email='$_SESSION[email]'";
...
<html lang="en" dir="ltr">
   ...
   <section id='container'>
     <div class="row">
       <div class="col-mid-2" id="left_sidebar">
         <img src="Screenshot (91).png" class=" img-rounded" width="200px" height="200px">
      ...
      <div class="col-mid-8" id="main_content">
        <h2>Welcome to user dashboard</h2>
        <p>This is the admin Dashboard page. Here admin can mangage notice board system. He can create a notice, delete a notice and all the replies of the notice.</p>
          <p>
